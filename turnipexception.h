...
const std::string BASE_PRICE_OUT_OF_RANGE = "Daisy Mae's Sunday price is not valid :(";
...
const std::string FILE_NOT_FOUND = "Csv not found!";
const std::string CSV_COL_NUM_INVALID = "Csv doesn't have 13 columns";
